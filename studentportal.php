		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example">
				<ul class="nav navbar-nav">
					...
					<li><a href="borrow-student.php">Книги</a></li>
					<li><a href="fine-student.php">Возвращённые книги</a></li>
				</ul>
...
<!--	  				<a href="#"><p class="slide2"><button class="btn btn-success">Войти</button></p></a>-->
	  			</div>
	  			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 column">
		  			<div class="page-header col-lg-offset-1">
		  				<h2>24/7 Быстрая поддержка</h2>
		  			</div>
	  				Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
	  				tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
	  				quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
...
<div class="container_fluid">
    ...
    <p class="page-header center-block">
        <a href="#"><button class="btn btn-primary">Контакты</button></a>
        <a href="#"><button class="btn btn-info">О нас</button></a>
