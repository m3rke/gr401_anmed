...
<script type="text/javascript">
	e.preventDefault();
	let book_id = $(this).find(".book-id"); //Get the id of the book;
	book_id = book_id.val();

    let book_name = $(this).find(".book-name"); //Get the name of the book;
	book_name = book_name.val();

    let purpose = $(this).find(".purpose"); //Get the purpose of the passing the value;
	purpose = purpose.val();
